 ...
 <xsl:template match="/">
  <div class="widget">
   <!--  <div class="widget_head">
    <xsl:value-of
     select="php:function('dctl_putRefs', string(*/*/@rend), $distinctSep, string($doc), $where, 1)"
     />
   </div>
-->
