          ...
          <ul class="collapsible sortable">
           ...
           <li class="widget" id="{concat($wherePrefix,'w3',$thisID)}">
            ...
            <div class="widget_body collapsible_body">
             ...
             <!-- lista scene -->
             <xsl:if
              test="tei:figure/dctl:studio//dctl:desc != '' or tei:figure/dctl:studio//tei:head != ''">
              <!-- almeno del contenuto! -->
...
-->
             ...
             <xsl:variable name="settings">
              ...
              <!-- select all -->
              <xsl:apply-templates select="tei:figure/dctl:studio/dctl:sceneList//dctl:settings" />
             </xsl:variable>
