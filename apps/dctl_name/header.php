...
$returnText .= '<h1 class="sitename">Laboratorio dCTL ('.APPS_VERSION.'): Banca dati autoritativa dei Nomi Propri&#160;&#160;<img id="progress" src="'.DCTL_IMAGES.'progress.gif" alt="(progress bar)" /></h1>';
$returnText .= '</div>';
...
<ul class="menu">
	...
	<li>Ricerca</li>
	<li>	<ul>
			<li><a href="searchByName.php">Cerca NOME</a></li>
	...
	<li>Aggiungi</li>
        <li>
		<ul>
			<li><a href="addName.php?">Forma Normalizzata</a></li>
	    		</ul>
	</li>
';
...
$returnText .= '<li>[ '.ucfirst($type1).' ]</li>';
$returnText .= '<li>';
$returnText .= '<ul>';
$returnText .= '<li><a href="listNameCollector.php?type='.$type1.'">Forme Norm.</a></li>';
$returnText .= '<li><a href="listNameAZ.php?type='.$type1.'">F.Norm.+F.Var.</a></li>';
$returnText .= '</ul>';
